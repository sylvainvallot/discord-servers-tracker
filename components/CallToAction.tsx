...
export default function CallToAction() {
    return (
      <div className="container p-12 flex flex-col lg:flex-row items-center justify-between">
        <div>
          <h3 className="font-bold text-3xl">Envie d&apos;ajouter votre serveur ?</h3>
          <p className="mt-6 text-lg leading-8">
            Contactez-moi sur Discord @syvt ou envoyez moi un email <a className="underline font-mono" href="mailto:contact@sylvainvallot.com">contact@sylvainvallot.com</a>
          </p>
        </div>
